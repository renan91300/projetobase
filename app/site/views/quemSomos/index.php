...
<main role="main">
    <div class="container marketing">
        ...
        <h2 class="display-4 text-center" style="margin-bottom: 50px">Quem Somos</h2>
        <hr class="featurette-divider">
        <?php
        $cont = 0;
        ...
        foreach ($this->dados['quemsomos'] as $quemsomos) {
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 <?= $ordem[1]; ?> <?= $anima[0]?>">
                    <img class="featurette-image img-fluid mx-auto rounded" src="<?=URL .'assets/img/quemsomos/' .$id .'/' .$imagem; ?>"
